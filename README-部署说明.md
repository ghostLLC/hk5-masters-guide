...
- 账号：ghostLLC
- 最近一次推送：2026-09-20（学费官网复核 + NUS 逐条核实，共 150 项）
...
| data.js | 150 个项目的数据库（学费/简介/要求/官网等） |
...
2026-09-20 删除 4 条 NUS 项目（经济学硕士、供应链管理理学硕士、数字金融科技理学硕士、创业学理学硕士）：其 website 均为大学首页或站点首页，两轮抓取都无法在官网定位到项目自身页面，按「资料只允许来自官网、宁缺毋滥」删除。删除清单记在 data.js 的 DATA_META.removedEntries，可凭 git 历史恢复。
